...
namespace ContosoUniversity.Data
{
    ...
    // This code initializes the empty database with test data
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            // EnsureCreated() creates a database if there isn't one already
            ...
            // Arrays are used to optimize performance. The arrays are then added to the 
            // DbContext (SchoolContext) instance's appropriate DbSet<T> property
            // In this case, the entity is Student, so this array of test data is appended to the DbSet<Student> property
            // The context then accepts the changes directly below the array initializer and the foreach loop
            ...
            // Write the changes to the database context
            context.SaveChanges();
